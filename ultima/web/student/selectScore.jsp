...
<div class="div_select">
    <form action="ServletOneStudentScore" method="post">
        课程名：<input type="text" class="form-control" id="form1" name="cosName"/> <input type="submit"
        ...
        <table class="table" style="width: 100%">
            ...
            <tr>
                <td colspan="7"><a onclick="page(1);">首页</a>
                    ...
                    跳转到：<input id="pageNo" type="text" class="form-control form1" name="pageNo"
                               value="${list.pageNo }"/>
                    每页记录数：<input type="text" name="pageCount" class="form-control" id="form1"
