...
<form action="ServletSearchScore" method="post" id="frm">
    <div class="div_list">
        ...
        学&nbsp;&nbsp;&nbsp;&nbsp;号：<input type="text" class="form1 form-control" name="stuNum"
                                          value="${score.getStuNum() }"/>&nbsp;&nbsp;&nbsp;&nbsp;
        姓&nbsp;&nbsp;&nbsp;&nbsp;名：<input type="text" class="form1 form-control" name="stuName"
                                          value="${score.getStuName() }"/><br/><br/>
        班&nbsp;&nbsp;&nbsp;&nbsp;级：<input type="text" class="form1 form-control" name="stuClass"
                                          value="${score.getStuClass() }"/>&nbsp;&nbsp;
        专&nbsp;&nbsp;&nbsp;&nbsp;业：<input type="text" class="form1 form-control" name="major"
                                          value="${score.getMajor() }"/> &nbsp;&nbsp;
            ...
            <table class="table panel-body" id="tableClass">
                ...
                <c:forEach var="list" items="${list.pbjs }">
                    <tr>
                        ...
                        <td>${list.getMajor() }</td>
                        <td><a href="ServletSelectScore?scoreID=${list.getScoreID() }">修改</a>&nbsp;&nbsp;&nbsp;<a
                                href="ServletDeleteScore?scoreID=${list.getScoreID() }"
                ...
                <tr>
                    <td colspan="7">
                        ...
                        <input type="submit" class="btn btn-primary" value="跳转"/> 共有${list.totalPage }页
                    </td>
                </tr>
            </table>
        </div>
